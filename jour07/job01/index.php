    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light ">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php">LPTF</a>
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a href="" class="nav-link disabled">Skills</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="row m-0 d-flex">
                <div class="col-2">
                    ...
                    <div class="jumbotron col pt-5 ps-4">
                            <h1 class="display-5">Bonjour, monde!</h2>
                            <p class="lead">Il existe plusieurs visions du terme : <br>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="spinner-border text-info ms-2   " role="status">
                ...
                <div class="col-2" style="width: 10rem;">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">Luxures</li>
